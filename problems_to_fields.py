...
classification_filename = {
    ...
    "Fields/Natural_Science.json": [
        19, 35, 75, 86, 94, 113, 123, 155, 161, 173, 175, 192, 194, 214, 216, 226, 234, 237, 254, 285, 309, 318, 329, 332, 338, 339, 340, 344, 345, 346, 348, 349, 351, 353, 354],
    "Fields/Sociocultural_Understanding.json": [
        ],
    "Fields/Data_and_StatisticalLiteracy.json": [
...
#     "Fields/Lang_Comp_and_Produc.json": [],
#     "Fields/Natural_Science.json": [
#         0, 1, 2, 3, 4, 5, 6, 10, 14, 17, 18, 19, 20, 22, 23, 25, 26, 33, 37, 38, 40],
#     "Fields/Sociocultural_Understanding.json": [
